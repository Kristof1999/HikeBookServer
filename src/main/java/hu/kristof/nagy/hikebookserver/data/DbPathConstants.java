...
public class DbPathConstants {
    ...
    public static final String USER_AVG_SPEED = "avgSpeed";
    public static final String USER_DETAILS = "details";
    public static final String USER_DETAILS_GROUP_NAMES = "groupNames";
    ...
    public static final String GROUP_DETAILS = "details";
    public static final String GROUP_DETAILS_MEMBER_NAMES = "memberNames";
}
